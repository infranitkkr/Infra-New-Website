    ...
    return (
        <div className='flex flex-col items-center mt-4 bg-white'>
            <div className='w-full border-b-2 p-3'>
                <h1 className='text-3xl sm:text-4xl font-bold pl-4 sm:pl-16'>
                    Contact Us
                </h1>
            </div>
            ...
            <div className='flex flex-col sm:flex-row w-full border-b-2 pb-20'>
                <div className='sm:w-1/2 w-full px-4 sm:px-8 pt-4'>
            ...
            <div className="relative w-full h-64 sm:h-[50vh] flex justify-start bg-black mt-20 pb-20">
                ...
                <div className="relative z-10 text-white text-center sm:text-left w-full p-4 sm:p-8 bg-opacity-50 rounded-lg h-full flex flex-col justify-between">
                    <div>
                        <h1 className="text-sm font-bold">Social Media</h1>
                        <p className="mt-2 text-xl sm:text-3xl font-extrabold">Unlock the full potential of social media</p>
                    ...
                    <div className='w-full flex flex-col sm:flex-row justify-around items-center gap-4 mt-4'>
                        <a target={'_blank'} rel="noopener noreferrer" href='https://www.instagram.com/infrastructure.nitkkr/'>
                            <Magnet>
                        ...
                        <a target={'_blank'} rel="noopener noreferrer" href='https://www.facebook.com/InfraSociety'>
                            <Magnet>
                                <div className='flex justify-center items-center gap-x-2 p-2 text-black bg-white rounded-2xl px-4'>
                        ...
                        <a target={'_blank'} rel="noopener noreferrer" href='https://www.linkedin.com/company/infrastructure-society-nit-kkr/'>
                            <Magnet>
                                <div className='flex justify-center items-center gap-x-2 p-2 text-black bg-white rounded-2xl px-4'>
            ...
            {/* Section 3: Find Us */}
            <div className='bg-gray-500 flex flex-col items-center mt-16 pt-8 w-full border-t-2 h-64 sm:h-[50vh] px-4'>
                <h1 className='text-red-400 font-extrabold text-lg sm:text-xl border-b-2 mb-4 w-full text-center'>
                    Find Us
                </h1>
                <p className='font-extrabold text-3xl sm:text-5xl text-center px-4'>
                    Meet the minds shaping an industry
                </p>
                <div className='flex flex-col sm:flex-row items-center justify-around w-full mt-8 gap-4'>
                    <div className='flex items-center justify-evenly w-full sm:w-1/4 h-16 border-2 rounded-full px-4'>
