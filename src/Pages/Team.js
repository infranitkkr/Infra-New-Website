...
import first from "../images/Post/1.jpeg";
import second from "../images/Post/2.png";
import third from "../images/Post/3.jpeg";
import fourth from "../images/Post/4.jpg";
import fifth from "../images/Post/5.png";
import sixth from "../images/Post/6.png";
          ...
          <div className="lg:flex md:flex sm:flex items-center xl:justify-around flex-wrap md:justify-around sm:justify-around lg:justify-around">
              ...
              <div className="rounded overflow-hidden shadow-md bg-white">
                <div className="absolute -mt-20 w-full flex justify-center">
                  <div className="h-32 w-32">
                    <img src={seventh} alt className="rounded-lg object-cover h-full w-full shadow-md" />
                  </div>
                </div>
                <div className="px-6 mt-16">
                  <div className="font-bold text-3xl text-center pb-1">Shivam Krishan Varshney</div>
                  <p className="text-gray-800 text-sm text-center">Developer</p>
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a target={'_blank'} href="https://github.com/Shivam-043" className="mx-5">
                      <div>
                    ...
                    <a target={'_blank'} href="https://www.instagram.com/vamshi_krishna_komati/" className="mx-5">
                      <div>
            ...
            {/* <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded overflow-hidden shadow-md bg-white">
                <div className="absolute -mt-20 w-full flex justify-center">
                  <div className="h-32 w-32">
                    <img src={require('../images/7.jpeg')} alt className="rounded-full object-cover h-full w-full shadow-md" />
                  </div>
                </div>
                <div className="px-6 mt-16">
                  ...
                  <p className="text-gray-800 text-sm text-center">Developer</p>
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a target={'_blank'} href="https://github.com/Kashish-Garg123" className="mx-5">
                      <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                          <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
                        </svg>
