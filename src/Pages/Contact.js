...
export default function Contact() {
    ...
    return (
        <div className='flex flex-col items-center mt-4 bg-white'>
            ...
            {/* Section 1: Form & Intro */}
            <div className='flex flex-col sm:flex-row w-full border-b-2 pb-20'>
                <div className='sm:w-1/2 sm:flex-col justify-start items-start w-full px-4 sm:px-8 pt-4'>
                    <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0}>
                        <h1 className='text-2xl sm:text-6xl font-extrabold text-center sm:text-left'>
                            Get In Touch
                        </h1>
                        <p className='mt-2 text-base sm:text-lg text-center sm:text-left px-2'>
                    ...
                    <AnimatedContent>
                        <form
                            className='flex flex-col w-full rounded-xl p-6 mt-6'
                            noValidate
                        ...
                        >
                            <div className='flex flex-col space-y-1 w-full'>
                                <input
                                    type='text'
                                    id='name'
                                    className='rounded-full w-full h-12 pl-4 border border-gray-500 bg-gray-50'
                                    placeholder='Name*'
                            ...
                            <div className='flex flex-col sm:flex-row justify-between gap-4 my-4'>
                                <div className='flex flex-col space-y-1 w-full sm:w-1/2'>
                                    <input
                                        type='email'
                                        id='email'
                                        className='rounded-full h-12 pl-4 w-full border border-gray-500 bg-gray-50'
                                        placeholder='Email*'
                            ...
                            <div className='h-48 sm:h-60'>
                                <textarea
                                    id='message'
                                    className='h-full w-full border border-gray-500 rounded-3xl bg-gray-50 pl-4 pt-3 resize-none'
                            ...
                            <div className='mt-8 flex flex-col'>
                                ...
                                <button
                                    type='submit'
                                    className="mt-2 py-2 px-4 bg-green-600 w-1/2 sm:w-1/3 text-white font-bold rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 self-center"
                                >
                                    Send message
                                </button>
                            </div>
                ...
                <div className='sm:w-1/2 w-full flex justify-center items-center h-72 sm:h-[90vh] mt-4 px-4'>
                    <iframe
                        title="NIT-KKR"
