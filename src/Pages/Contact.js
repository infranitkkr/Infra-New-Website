                ...
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                        <div className="flex justify-center items-center mx-auto gap-x-8 mt-6">
                            ...
                            <a target={'_blank'} href='mailto: infrastructure@nitkkr.ac.in' type=''>
                        ...
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <a class="text-gray-500">infrastructure@nitkkr.ac.in</a>
                            <p class="leading-normal my-5 font-bold">Infrastructure
                                <br />Society
                            </p>
                        </div>
                    </div>
