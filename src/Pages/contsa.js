    ...
    return (
        <div className='flex flex-col items-center mt-4 bg-white'>
            ...
            <div className='sm:flex sm:flex-row flex-col  w-full border-b-2 pb-20 '>
                <div className='sm:flex-col justify-start items-center sm:w-1/2 w-full px-8 pt-4  mx-4 mt-4 '>
            ...
            {/* section 3 */}
                ...
                <div className=' bg-gray-500 flex flex-col justify-start items-center mt-16 pt-8  w-full border-t-2  h-[50vh]'>
