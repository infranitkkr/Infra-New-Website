...
const OForm = () => {
  ...
  const onSubmit = async (data) => {
    try {
      console.log(data)
      const response = await fetch('https://infra-event-form.onrender.com/submit/opinion', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className=' flex flex-col items-center justify-center '>
      ...
      <h1 className="text-3xl font-bold mb-6 text-gray-800 flex justify-center items-center">Opinion Olympics</h1>
